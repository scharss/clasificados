...
function readTask(){
  ...
  <div class="card mb-3">
    <div class="card-body" style="background-color:#DFE3EA">
             ...
             <p><button type="submit" style="color:white" class="btn btn-dark" onclick="updateTask(${taskValue.id},'${taskValue.task}','${taskValue.description}')"><i class="fas fa-edit"></i> Editar Clasificado</button></p>
...
function reset(){
  ...
  <form class="border p-4 mb-4" id="form">
                ...
                <input type="text"  id="task" placeholder="Clasificado" class="form-control">
                </div>
                ...
                <button type="submit" id="button1" class="btn btn-dark"><i class="fas fa-plus"></i> Agregar Clasificado</button>
                <button style="display: none" id="button2" class="btn btn-dark"> Editar Clasificado</button>  
...
function updateTask(id,name,description){
  document.getElementById("firstSection").innerHTML=`
                ...
                <div class="form-group">
                <label><strong>Clasificado</strong></label>    
                <input type="text"  id="task" placeholder="Clasificado" class="form-control">
                </div>
